...
jQuery(document).ready(function($){
	...
	// Display First Tab on Page Refresh 
	...
	// event.preventDefault();
		...
		$.cookie('of_current_opt', clicked_group, { path: '/' });
	...
	$('#expand_options').click(function(){
		if(flip == 0){
			...
			$('#of_container #content').width(950);
			...
			$('#of_container #content').width(770);
	...
	/**	Tipsy @since v1.3 */
	if (jQuery().tipsy) {
		$('.typography-size, .typography-height, .typography-face, .typography-style, .typography-weight, .of-typography-color').tipsy({
			fade: true,
			gravity: 's',
			opacity: 0.7,
		});
	...
	$('#section-tpath_demo_content .demo_content').live('click', function(e) {
		var confirm = window.confirm('WARNING: Clicking this button will replace your content. Importing demo content is recommended on fresh installs only once. Importing on sites with content or importing twice will duplicate menus, pages and all posts. It can also take a minute to complete.');
	...
	$('#section-tpath_demo_theme_options .theme_options').live('click', function(e) {
		var confirm = window.confirm('WARNING: Clicking this button will replace your current theme options. Importing demo theme options is recommended on fresh installs only once. It can also take a minute to complete.');
