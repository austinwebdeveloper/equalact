...
"Vesper Libre" => "Vesper Libre", "Vibur" => "Vibur", "Vidaloka" => "Vidaloka", "Viga" => "Viga", "Voces" => "Voces", "Volkhov" => "Volkhov", "Vollkorn" => "Vollkorn", "Voltaire" => "Voltaire", "Waiting for the Sunrise" => "Waiting for the Sunrise", "Wallpoet" => "Wallpoet", "Walter Turncoat" => "Walter Turncoat", "Warnes" => "Warnes", "Wellfleet" => "Wellfleet", "Wendy One" => "Wendy One", "Wire One" => "Wire One", "Yanone Kaffeesatz" => "Yanone Kaffeesatz", "Yellowtail" => "Yellowtail", "Yeseva One" => "Yeseva One", "Yesteryear" => "Yesteryear", "Zeyada" => "Zeyada");
				...
				case 'button':
					$src = $value['std'];
					$output .= '<button href="' . $src . '" class="button btn-primary '.$value['class'].'" type="button">' . $value['text'] . '</button>';
				break;
				...
				case 'buttons':
					...
					$alt_src = $value['alt_std'];
					$output .= '   <button href="' . $alt_src . '" class="button btn-primary '.$value['class'].'" type="button">' . $value['alt_text'] . '</button>';
				break;
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ', 'Templatepath').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
