 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
class Tpath_WP_Import extends WP_Importer {
...
<?php
	...
	function process_menu_item( $item ) {
		...
		$args = array(
			...
			'menu_item_tpath_megamenu_menutype' => $_menu_item_tpath_megamenu_menutype,
			'menu_item_tpath_megamenu_status' => $_menu_item_tpath_megamenu_status,
			'menu_item_tpath_megamenu_columns' => $_menu_item_tpath_megamenu_columns,
			'menu_item_tpath_megamenu_title' => $_menu_item_tpath_megamenu_title,
			'menu_item_tpath_megamenu_link' => $_menu_item_tpath_megamenu_link,
			'menu_item_tpath_megamenu_content' => $_menu_item_tpath_megamenu_content,
			'menu_item_tpath_megamenu_icon' => $_menu_item_tpath_megamenu_icon,
			'menu-item-status' => $item['status']
		);

		$id = tpath_wp_update_nav_menu_item( $menu_id, 0, $args );
...
if ( !function_exists( 'tpath_wp_update_nav_menu_item' ) ) {
	
	function tpath_wp_update_nav_menu_item( $menu_id = 0, $menu_item_db_id = 0, $menu_item_data = array() ) {
		...
		$defaults = array(
			...
			'menu-item-classes' => '',
			'menu-item-xfn' => '',			
			'menu-item-tpath-megamenu-menutype' => '',
			'menu-item-tpath-megamenu-status' => '',
			'menu-item-tpath-megamenu-columns' => '',
			'menu-item-tpath-megamenu-title' => '',
			'menu-item-tpath-megamenu-link' => '',
			'menu-item-tpath-megamenu-content' => '',
			'menu-item-tpath-megamenu-icon' => '',
			'menu-item-status' => '',
		);
		...
		// Custom Fields
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_menutype', $args['menu_item_tpath_megamenu_menutype'] );
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_status', $args['menu_item_tpath_megamenu_status'] );
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_columns', $args['menu_item_tpath_megamenu_columns'] );
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_title', $args['menu_item_tpath_megamenu_title'] );
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_link', $args['menu_item_tpath_megamenu_link'] );
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_content', $args['menu_item_tpath_megamenu_content'] );
		update_post_meta( $menu_item_db_id, '_menu_item_tpath_megamenu_icon', $args['menu_item_tpath_megamenu_icon'] );
		...
		do_action('tpath_wp_update_nav_menu_item', $menu_id, $menu_item_db_id, $args );
