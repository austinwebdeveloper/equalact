	...
	<div class="container">
		...
		<div class="navbar-collapse tpath-mainnavbar-collapse collapse tpath-header-main-bar">
			<ul class="nav navbar-nav tpath-main-bar">
				...
				<?php if ( isset( $tpath_options['tpath_contact_msg']) && $tpath_options['tpath_contact_msg'] != '' ) { ?>
				<li class="extra-nav contact-nav">
					<p class="contact-info"><?php echo force_balance_tags( $tpath_options['tpath_contact_msg'] ); ?></p>
				</li>
				<?php } ?>
			</ul>
		</div>
