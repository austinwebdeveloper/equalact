	...
	<div class="container">
		...
		<div class="navbar-collapse tpath-mainnavbar-collapse collapse tpath-header-main-bar">
			<ul class="nav navbar-nav tpath-main-bar">
				...
				<?php if ( isset( $tpath_options['tpath_enable_socials_in_header']) && $tpath_options['tpath_enable_socials_in_header'] == 1 ) { ?>
				<li class="extra-nav socials-nav"><?php justice_header_content_area( 'social-links' ); ?></li>
				<?php } ?>
			</ul>
		</div>
	</div><!-- .container -->
