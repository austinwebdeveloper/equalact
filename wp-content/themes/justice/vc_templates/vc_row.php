...
if( $this->settings( 'base' ) === 'vc_row_inner' ) {
	$css_classes[] = ' tpath-vc-section-inner';
} else {
	$css_classes[] = ' tpath-vc-section ';
}

// Custom Background Style
if( isset( $background_style ) && $background_style != '' ) {
	$css_classes[] = ' bg-style ' . $background_style;
}

// Background Overlay Style
if( isset( $background_style ) && $background_style == 'overlay-wrapper' ) {
	if( isset( $bg_overlay_style ) && $bg_overlay_style != '' ) {
		$css_classes[] = ' bg-overlay ' . $bg_overlay_style;
	}
}
...
echo '<div class="tpath-row-inner-wrapper">';
	if ( 'yes' == $center_row ) {
		echo '<div class="container">';
	}
	
	if ( 'yes' == $center_row && 'stretch_row_content_no_spaces' !== $full_width ) {
		echo '<div class="row">';
	}
